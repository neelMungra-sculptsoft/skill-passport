export default function HeaderDescription() {
  return (
    <div className="px-4 sm:px-10 pb-6 border-t border-slate-700 pt-4">
      <p className="text-sm text-navy-subtle leading-relaxed mb-2">
        At Lumi, we ignite potential by helping people build the skills that matter most—creative
        problem-solving, AI fluency, and entrepreneurial thinking.
      </p>
      <p className="text-sm text-navy-subtle leading-relaxed mb-2">
